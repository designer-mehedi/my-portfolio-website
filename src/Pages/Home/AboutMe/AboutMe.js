...
const AboutMe = () => {
    return (
        <section className="lg:container px-32 grid grid-cols-1 lg:grid-cols-2 gap-12 py-28">
            <div>
                <img src={about} alt="" />
            </div>
            <div>
                <h3 className="text-xl font-medium text-sky-600">About Me</h3>
                <h2 className="text-5xl font-bold mb-5">Front End Developer</h2>
